...
//
//public class buildingSnake extends AppCompatActivity {
//
//    VideoView videoView;
...
//        setContentView(R.layout.activity_building_snake);
//
//
//        Log.e("building","snake");
//        videoView = findViewById(R.id.video_snake);
//        mediaController = new MediaController(this);
//        mediaController.setAnchorView(videoView);
//        mediaController.setPadding(0, 0, 0, 105);
//        Uri uri = Uri.parse("android.resource://"+getPackageName()+"/raw/withcubesnake");
//
